      ...
      <form onSubmit={this.handleSubmit} style={background}>
        <div style={letterStyle}>
          ...
          <fieldset style={formbackground}>
            <div>
              <label>
                What is the name of the person you would like to get a
            ...
            <div>
              <label>
                Other places defendant may be found (friends, bars, relatives,
                hangouts)
                <div style={hel}>
                  <input type="text" />
                </div>
            ...
            <div>
              <label>
                Does this person have a history of violence toward polic
                officers?
                <div style={hel}>
